#==== fOOrth_object.rb
#The generic object class of the fOOrth language system.
module XfOOrth
  #The \XfOOrthObject class is basis for all fOOrth objects.
  ...
  class XfOOrthObject
    ...
    def fOOrth_class; self.class.fOOrth_class; end
    ...
    def add_exclusive_method(symbol, &block)
      @exclusive ||= Hash.new     #??? WIP Should this not be a SymMap ???
      @exclusive[symbol] = block  #??? WIP @exclusive[symbol].block = block
