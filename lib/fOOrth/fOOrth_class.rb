#==== fOOrth_class.rb
#The generic class class of the fOOrth language system.
module XfOOrth
  require_relative 'fOOrth_exceptions'
  require_relative 'fOOrth_object'

  #The \XfOOrthClass class is basis for all fOOrth classes.
  class XfOOrthClass < XfOOrthObject
    $all_classes  = Hash.new    #cop out!

    #Get the object class.
    def self.object_class; $all_classes['Object']; end

    #Get the class class.
    def self.class_class; $all_classes['Class']; end

    #Get the virtual machine class.
    def self.vm_class; $all_classes['VirtualMachine']; end

    #The base Ruby class for instances of this class.
    def instance_base_class; XfOOrthObject; end
    ...
    def initialize(name, fOOrth_parent)
      ...
      if $all_classes.has_key?(@name)
        error 'Class #{@name} already exists.'
      end

      $all_classes[@name]  = self
